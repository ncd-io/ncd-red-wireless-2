		...
		'520': {
			...
			parse: (payload, parsed) => {
				...
				return {
					...
					current_6_ma: payload.slice(30, 32).reduce(msbLsb),
					frequency_6: payload.slice(32, 34).reduce(msbLsb),
					temperature: signInt(payload.slice(34, 36).reduce(msbLsb), 16) * 100,
