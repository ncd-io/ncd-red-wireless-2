...
module.exports = class WirelessSensor{
	...
	parse(frame){
		...
		if(typeof this[type] == 'function'){
			...
			// #OTF
			var otf_devices = [80,81,82,84,101,102];
			//var device_type = msbLsb(frame.data[6], frame.data[7]);
			var device_type = frame.data[7];
			if(otf_devices.includes(device_type)){
				if(frame.data[9] == 70 && frame.data[10] == 76 && frame.data[11] == 89) {
					var broadcast_otf_devices = [101,102];
					frame.data = frame.data.concat([0,0,255,255,0,10,10,14,14,1,0,0,4,4,8,1])
					mode = "FLY";
					...
					// #MARK braodcast OTF Added back in to maintain support for type 101 and 102
					// if(broadcast_otf_devices.includes(device_type)){
					// 	this.fly_101_in_progress = true;
					// 	console.log('Broadcasting RTC');
					...
					// }
					// return {data: "OTF Command Received"};


				// Commented out as this packet does not match normal packet structure, may be fixed in future firmware.
				// }else if(frame.data[7] == 79 && frame.data[8] == 84 && frame.data[9] == 78 && !this.hasOwnProperty('fly_101_in_progress')){
				// 	console.log('-------------------------------------------');
				// 	console.log('OTN Initiated');
				// 	mode = "OTN";
				}
			}
			if(mode == 'ACK'){
				if(frame.data[7] == 79 && frame.data[8] == 84 && frame.data[9] == 78){
				//	data.sensor_type = msbLsb(frame.data[2], frame.data[3]);
			...
			if(mode === 'FLY' && frame.data.length > 12 && typeof this.sensor_types[device_type].parse_fly == 'function'){
				this.sensor_pool[frame.mac].reported_config = this.sensor_types[device_type].parse_fly(frame.data);
			}
			var that = this;
	...
	sensor_data(payload, frame){
		...
		if(otf_devices.includes(parsed.sensor_type)){
			...
			if(payload[8] == 70 && payload[9] == 76 && payload[10] == 89) {
				...
				// this.fly_101_in_progress = true;
				// this.sensor_pool[frame.mac].type = "FLY";
				// this._emitter.emit('sensor_mode', this.sensor_pool[frame.mac]);
				// this._emitter.emit('sensor_mode-'+frame.mac, this.sensor_pool[frame.mac]);
				// if(broadcast_otf_devices.includes(parsed.sensor_type)){
				// 	console.log('Broadcasting RTC');
				// 	setTimeout(() => {this.config_set_rtc_101('00:00:00:00:00:00:FF:FF')}, 1000);
				// }else{
				// 	console.log('Sending RTC');
		...
		if(payload.length == 179){
			...
			if(typeof this.sensor_types[parsed.sensor_type] == 'undefined'){
				...
				// #OTF
			}else if(parsed.sensor_type == 80 ||  parsed.sensor_type == 81 || parsed.sensor_type == 82 || parsed.sensor_type == 84 || parsed.sensor_type == 515){
	...
	config_enter_otn_mode(sensor_mac){
		console.log('config_enter_otf_mode');
		// F4 4F 00 00 65 32
	...
	var types = {
		...
		'76': {
			...
			parse: (d) => {
				return {
					adc: signInt(d.slice(0, 2).reduce(msbLsb), 16),
					mA: signInt(d.slice(2, 4).reduce(msbLsb), 16)/100,
					CO_ppm: (d.slice(4, 8).reduce(msbLsb))/100
				};
			}
		},
		...
		'80': {
			...
			'parse_fly': (frame) => {
				...
				switch(frame[17]){
					case 6:
						frame_data.odr_1 = "50Hz";
						break;
					case 7:
						frame_data.odr_1 = "100Hz";
						break;
					case 8:
						frame_data.odr_1 = "200Hz";
						break;
					case 9:
						frame_data.odr_1 = "400Hz";
						break;
					case 10:
						frame_data.odr_1 = "800Hz";
						break;
					case 11:
						frame_data.odr_1 = "1600Hz";
						break;
					case 12:
						frame_data.odr_1 = "3200Hz";
						break;
					case 13:
						frame_data.odr_1 = "6400Hz";
						break;
					case 14:
						frame_data.odr_1 = "12800Hz";
						break;
					case 15:
						frame_data.odr_1 = "25600Hz";
						break;
				}
				...
				switch(frame[22]){
					case 0:
						frame_data.low_freq_1 = "4";
						break;
					case 1:
						frame_data.low_freq_1 = "8";
						break;
					case 2:
						frame_data.low_freq_1 = "16";
						break;
					case 2:
						frame_data.low_freq_1 = "32";
						break;
					case 4:
						frame_data.low_freq_1 = "64";
						break;
					case 5:
						frame_data.low_freq_1 = "128";
						break;
					case 6:
						frame_data.low_freq_1 = "256";
						break;
					case 7:
						frame_data.low_freq_1 = "512";
						break;
					case 8:
						frame_data.low_freq_1 = "1024";
						break;
					case 9:
						frame_data.low_freq_1 = "2048";
						break;
				}
				switch(frame[24]){
					case 0:
						frame_data.high_freq_1 = "4";
						break;
					case 1:
						frame_data.high_freq_1 = "8";
						break;
					case 2:
						frame_data.high_freq_1 = "16";
						break;
					case 2:
						frame_data.high_freq_1 = "32";
						break;
					case 4:
						frame_data.high_freq_1 = "64";
						break;
					case 5:
						frame_data.high_freq_1 = "128";
						break;
					case 6:
						frame_data.high_freq_1 = "256";
						break;
					case 7:
						frame_data.high_freq_1 = "512";
						break;
					case 8:
						frame_data.high_freq_1 = "1024";
						break;
					case 9:
						frame_data.high_freq_1 = "2048";
						break;
				}
				switch(frame[26]){
					case 0:
				...
				return {
					...
					'odr_1': frame_data.odr_1,
					'sampling_duration_1': frame_data.sampling_duration_1,
					'filter_status': frame_data.filter_status,
					'low_freq_1': frame_data.low_freq_1,
					'high_freq_1': frame_data.high_freq_1,
		...
		'81': {
			...
			'parse_fly': (frame) => {
				...
				switch(frame[18]){
					case 6:
						frame_data.odr_2 = "50Hz";
						break;
					case 7:
						frame_data.odr_2 = "100Hz";
						break;
					case 8:
						frame_data.odr_2 = "200Hz";
						break;
					case 9:
						frame_data.odr_2 = "400Hz";
						break;
					case 10:
						frame_data.odr_2 = "800Hz";
						break;
					case 11:
						frame_data.odr_2 = "1600Hz";
						break;
					case 12:
						frame_data.odr_2 = "3200Hz";
						break;
					case 13:
						frame_data.odr_2 = "6400Hz";
						break;
					case 14:
						frame_data.odr_2 = "12800Hz";
						break;
					case 15:
						frame_data.odr_2 = "25600Hz";
						break;
				}
				frame_data.sampling_duration_1 = frame[19]*50 + "ms";
				...
				switch(frame[23]){
					case 0:
						frame_data.low_freq_2 = "4";
						break;
					case 1:
						frame_data.low_freq_2 = "8";
						break;
					case 2:
						frame_data.low_freq_2 = "16";
						break;
					case 2:
						frame_data.low_freq_2 = "32";
						break;
					case 4:
						frame_data.low_freq_2 = "64";
						break;
					case 5:
						frame_data.low_freq_2 = "128";
						break;
					case 6:
						frame_data.low_freq_2 = "256";
						break;
					case 7:
						frame_data.low_freq_2 = "512";
						break;
					case 8:
						frame_data.low_freq_2 = "1024";
						break;
					case 9:
						frame_data.low_freq_2 = "2048";
						break;
				}
				switch(frame[24]){
					case 0:
				...
				switch(frame[25]){
					case 0:
						frame_data.high_freq_2 = "4";
						break;
					case 1:
						frame_data.high_freq_2 = "8";
						break;
					case 2:
						frame_data.high_freq_2 = "16";
						break;
					case 2:
						frame_data.high_freq_2 = "32";
						break;
					case 4:
						frame_data.high_freq_2 = "64";
						break;
					case 5:
						frame_data.high_freq_2 = "128";
						break;
					case 6:
						frame_data.high_freq_2 = "256";
						break;
					case 7:
						frame_data.high_freq_2 = "512";
						break;
					case 8:
						frame_data.high_freq_2 = "1024";
						break;
					case 9:
						frame_data.high_freq_2 = "2048";
						break;
				}
				switch(frame[26]){
					case 0:
				...
				return {
					...
					'mode': frame_data.mode,
					'odr_1': frame_data.odr_1,
					'odr_2': frame_data.odr_2,
					'sampling_duration_1': frame_data.sampling_duration_1,
					'sampling_duration_2': frame_data.sampling_duration_2,
					'filter_status': frame_data.filter_status,
					'low_freq_1': frame_data.low_freq_1,
					'low_freq_2': frame_data.low_freq_2,
					'high_freq_1': frame_data.high_freq_1,
					'high_freq_2': frame_data.high_freq_2,
					'sampling_interval': frame_data.sampling_interval,
					'on_request_timeout': frame_data.on_request_timeout,
					'machine_values': {
						'destination_address': toMac(frame.slice(12, 16), false),
