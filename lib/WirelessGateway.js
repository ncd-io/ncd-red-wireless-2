...
module.exports = class WirelessSensor{
	...
	parse(frame){
		...
		if(typeof this[type] == 'function'){
			...
			if(mode === 'FLY' && frame.data.length > 12 && typeof this.sensor_types[device_type].parse_fly == 'function' || mode === 'OTF' && frame.data.length > 12 && typeof this.sensor_types[device_type].parse_fly == 'function'){
